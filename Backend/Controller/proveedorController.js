...
controller.edit = (req, res) => {
    ...
    req.getConnection((err,conn) =>{
        conn.query('select *from proveedor where idproveedor=?', [idproveedor], (err,proveedor) => {
...
controller.update = (req,res) =>{
    ...
    req.getConnection((err, conn) => {
        conn.query('update proveedor set ? where idproveedor =?', [nuevo_proveedor, idproveedor], (err,rows) =>{ 
